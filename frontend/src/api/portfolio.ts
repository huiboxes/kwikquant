 ...
 *  - GET /api/v1/portfolio/equity-curve  → EquityPointDto[](注:后端无此端点,MSW mock 占位)
 *
 * 注:equityCurve 字段只在回测报告 schema(api-gen line 1718/3347),portfolio/pnl 无曲线端点,
