 ...
 * 注:后端无"列表 ticker"端点,前端产品精选 top 8 symbol(非 mock)循环 GET;
 * 中期后端 /market/pairs 加 volume 排序 top N 解 hardcode(待补齐)。 */
 ...
 * 注:后端无"列表 kline"端点,前端产品精选 symbol 循环 useQueries 批量(同 useTickers 模式)。 */
