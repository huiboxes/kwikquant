...
export interface paths {
    "/api/v1/strategies/{strategyId}/codes/{codeId}": {
        ...
        /**
         * 查代码版本详情
         * @description 需 JWT 鉴权。返回含 sourceCode 正文（list 端点不含 sourceCode，前端 Monaco reload 草稿走此端点）。代码不存在/非本人返回 404（7004）；策略不存在返回 404（7001）。
         */
        get: operations["get"];
        /**
         * 更新代码草稿
    ...
    "/api/v1/backtests": {
        ...
        /**
         * 提交回测任务
         * @description 需 JWT 鉴权。异步提交，立即返回 PENDING 状态的 task（含 taskId）。策略不存在返回 404（7001）；无发布代码返回 409（7006）。前端用 taskId 轮询 GET /backtests/{id}，状态机见 docs/behavior-contract.md 回测轮询协议一节。
         */
...
export interface components {
    schemas: {
        ...
        BacktestTaskDto: {
            ...
            /**
             * Format: int64
             * @description 回测报告 ID（COMPLETED 时有值，task→report 导航桥梁）
             * @default
             */
            reportId: number;
            /**
