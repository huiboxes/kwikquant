...
public class CcxtAuthExchangeFactory {
    ...
    public io.github.ccxt.Exchange createAuthExchange(ExchangeAccount account, MarketType marketType) {
        ...
        // 原 4a.2 待补齐"路线 B 预留"在此落地,信号源 CcxtProperties.sandbox(dev/test true,prod false)。
        // per-account testnet 精细化(同交易所 demo+prod key 共存)待补齐,需 ExchangeAccount 加字段 + Flyway。
