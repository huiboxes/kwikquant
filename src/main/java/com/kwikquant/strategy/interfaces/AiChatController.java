...
/**
 * AI Chat 端点(tech-design §5 C 层 会话历史持久化 + §3 A 层 模型选择 入口)。
 *
 ...
 *
 * <p><b>会话历史持久化(tech-design §5.2)</b>：新增三个端点管理 per-strategy 会话历史：
 * <ul>
...
class AiChatController {
    ...
    public Flux<ServerSentEvent<String>> chat(@Valid @RequestBody AiChatRequest request) {
        ...
        // tech-design §5.2: user 消息后端存(controller 层 blocking DB 写,在返 Flux 前)。
