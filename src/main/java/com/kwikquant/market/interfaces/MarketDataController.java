...
class MarketDataController {
    ...
    ApiResponse<TickerResponse> ticker(
        ...
        // 暴露 stale 状态：设计  NORMAL/STALE 二状态质量守卫在 REST 层落地
    ...
    ApiResponse<List<Kline>> klines(
            ...
            @Parameter(
                    ...
                    String before) {
        // Instant.parse 非法串抛 DateTimeParseException → 默认 500;显式校验返 400(防脏串污染监控)。
    ...
    /** ticker 端点响应：携带行情快照 + stale 状态（NORMAL/STALE 双语义）。 */
