...
public record TradeHistoryStatsDto(
        ...
        @Schema(description = "累计手续费（USDT 估值口径，精度 2 位）", example = "76.17") BigDecimal totalFees,
        @Schema(description = "已实现盈亏（USDT 估值口径，精度 2 位，负值为亏损）", example = "3210.45") BigDecimal realizedPnl,
        @Schema(description = "总交易天数", example = "7") long tradingDays,
