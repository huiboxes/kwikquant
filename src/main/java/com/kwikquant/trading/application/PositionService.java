 ...
 *
 * <p>合约语义的开仓 / 加仓 / 减仓 / 平仓反手计算规则详见 -。
 * 现货场景 side 始终 long 或 flat。
 *
 * <p>扩支持 PERP 合约持仓:SPOT 沿用 {@link #applyDelta} 反手分支(逐字保留),
 * PERP 走 {@link #applyPerpDelta} 按 {@link PositionEffect} 四向分桶,无反手。
 */
@Service
public class PositionService {

    /** 逐仓简化强平价计算默认维持保证金率。{@code recomputeAllLiquidationPrices} 可覆盖。 */
     ...
     * <ul>
     *   <li>fillQty &gt; position.qty → 抛 {@link RejectFillException}( ③, 定案 4 优先抛非 cap)</li>
    ...
    /**
     * 跨账户查某 symbol 某交易所的所有模拟盘 PERP 持仓。
     *
