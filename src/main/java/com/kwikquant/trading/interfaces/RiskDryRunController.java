 ...
 * 风控预检 REST API。
 *
 * <p>{@code POST /api/v1/risk/dry-run}：用与真实下单（{@code TradingService.submit}）<b>基本相同</b>
...
public class RiskDryRunController {
    ...
    public ApiResponse<RiskDryRunResult> dryRun(@Valid @RequestBody RiskDryRunRequest req) {
        ...
        // 否则 notional=null 在无 MAX_NOTIONAL 策略账户会 false-APPROVE，违背 faithfulness。
        ...
        // insertOrder(REQUIRES_NEW 独立 tx) 后 countRecentOrders 必然含当前单的 N+1。
