...
/**
 * End-to-end integration test for the risk → notification link (scenarios 1-2).
 *
...
class RiskNotificationE2ETest extends AbstractIntegrationTest {
    ...
    /**
     * Scenario 1: order rejected by risk → WebSocket notification pushed, with the reason
     * carrying only the rule type (desensitisation: threshold values must not leak).
     */
    @Test
    ...
    /**
     * Scenario 2: order approved by risk → routed to paper executor, no RISK_REJECTED
