...
class PaperExecutorTest {
    ...
    /**
     * 基准交易所过滤。order.referenceExchange=BINANCE,ticker 来自 OKX(同 symbol BTC/USDT,
    ...
    private Order order(long id, OrderStatus status) {
        ...
        // 基准所默认 BINANCE(onTicker 过滤需要非 null;现有测试 ticker 都是 BINANCE)
