...
class BacktestOrderServiceTest {
    ...
    /**
     * 回测 PERP 撮合(最小方案:撮合+保证金+PnL,不模拟强平/资金费率)。
    ...
    /**
     * 回测 PERP OPEN+CLOSE 链路:OPEN_LONG 42150 @ 10x → CLOSE_LONG 43000 不抛,
    ...
    /** PERP 不拒,task not running 抛 7303(无 ledger)。 */
    @Test
