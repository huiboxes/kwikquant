...
class ErrorCodeTest {
    ...
    void allErrorCodeValuesMustBeUnique() throws Exception {
        ...
        assertEquals(
                53,
                count,
                "Expected 53 ErrorCode constants (13 base + 9 trading 41xx + 2 risk 20xx + 6 strategy 70xx + 3 backtest 71xx + 3 worker 72xx + 4  73xx + 5 AI 80xx + 4 report 90xx + 4 mcp 10xxx)");
    }
}
